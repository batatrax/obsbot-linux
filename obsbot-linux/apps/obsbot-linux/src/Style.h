/**
 * @file Style.h
 * @brief Systeme de design (design tokens + stylesheet Qt globale).
 *
 * Palette Catppuccin Mocha :
 *   COLOR_BG      : #1e1e2e  (fond principal)
 *   COLOR_SURFACE : #24243e  (surfaces secondaires)
 *   COLOR_CARD    : #313244  (cartes/widgets)
 *   COLOR_ACCENT  : #89b4fa  (bleu accent)
 *   COLOR_SUCCESS : #a6e3a1  (vert succes)
 *   COLOR_ERROR   : #f38ba8  (rouge erreur)
 *   COLOR_TEXT    : #cdd6f4  (texte principal)
 *
 * Usage :
